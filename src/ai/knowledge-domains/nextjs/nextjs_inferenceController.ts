...
function generateServerComponentResponse(_input: string, analysis: any): string {
...
function generateClientComponentResponse(_input: string, analysis: any): string {
...
function generateApiResponse(_input: string, analysis: any): string {
...
function generateConfigResponse(_input: string, analysis: any): string {
...
function generateDeploymentResponse(_input: string, analysis: any): string {

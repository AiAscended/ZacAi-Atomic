...
export const getDocumentationEmbeddingForTokens = (tokens: string[]) =>
  tokens.map(getDocumentationEmbedding);

export const persistDocumentationWeights = (
  ...
  try {
    ...
    updateFile(
      ...
      "src/ai/knowledge-domains/documentation/documentation_weights/documentation_pretrained_weights.json",
      content,
    );
    return true;
  } catch (e) {

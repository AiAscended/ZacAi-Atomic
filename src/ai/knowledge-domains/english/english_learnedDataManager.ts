...
export const loadEnglishLearnedData = async (path = "/src/ai/knowledge-domains/english/english_learned/english_learnedData.json") => {
  try {
...
export const saveEnglishLearnedData = async (data: unknown, path = "/src/ai/knowledge-domains/english/english_learned/english_learnedData.json") => {
  try {

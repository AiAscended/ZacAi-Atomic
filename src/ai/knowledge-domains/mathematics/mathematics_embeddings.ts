...
export const getMathematicsEmbeddingForTokens = (tokens: string[]) =>
  tokens.map(getMathematicsEmbedding);

export const persistMathematicsWeights = (weights: Record<string, number[]>) => {
  try {

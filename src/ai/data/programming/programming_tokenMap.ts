import { ALL_PROGRAMMING_TOKENS, PROGRAMMING_SPECIAL_TOKENS, type ProgrammingToken } from "./programming_tokens"
...
export class ProgrammingTokenMap {
  ...
  public getTokenId(text: string): number {
    return this.tokenToId.get(text.toLowerCase()) ?? PROGRAMMING_SPECIAL_TOKENS.UNK
  }
